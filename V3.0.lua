...
--]]
local Altrix30 = Instance.new("ScreenGui")
...
Altrix30.Name = "Altrix (3.0)"
Altrix30.Parent = game.Players.LocalPlayer:WaitForChild("PlayerGui")
Altrix30.DisplayOrder = 999999999
Altrix30.ResetOnSpawn = false

core.Name = "core"
core.Parent = Altrix30
...
VN.Position = UDim2.new(0.899999976, 0, 0, 0)
VN.Size = UDim2.new(0.100000001, 0, 0.600000024, 0)
VN.ZIndex = 5
...
local function PWEHRP_fake_script() -- Altrix30.Changelog 
	local script = Instance.new('LocalScript', Altrix30)
...
coroutine.wrap(PWEHRP_fake_script)()
local function ZIHITY_fake_script() -- Command.keybind 
...
coroutine.wrap(ZIHITY_fake_script)()
local function FJXEGNI_fake_script() -- corescripts.commandhandler 
...
coroutine.wrap(FJXEGNI_fake_script)()
local function BHFU_fake_script() -- corescripts.draggable 
	local script = Instance.new('Script', corescripts)

	local frame = script.Parent.Parent.Header
...
coroutine.wrap(BHFU_fake_script)()
local function QYHQVO_fake_script() -- Header_2.draggable 
	local script = Instance.new('Script', Header_2)
...
coroutine.wrap(QYHQVO_fake_script)()
local function LTEXBZP_fake_script() -- Close.Closer 
...
coroutine.wrap(LTEXBZP_fake_script)()
local function IXKC_fake_script() -- Header_2.HideOnRun 
	local script = Instance.new('LocalScript', Header_2)

	script.Parent.Visible = false
	script:Destroy()
end
coroutine.wrap(IXKC_fake_script)()
local function ZLAKCX_fake_script() -- walkair_2.walkair 
...
coroutine.wrap(ZLAKCX_fake_script)()
local function TZVLUI_fake_script() -- Header_3.draggable 
	local script = Instance.new('Script', Header_3)
...
coroutine.wrap(TZVLUI_fake_script)()
local function GIFB_fake_script() -- Close_2.Closer 
...
coroutine.wrap(GIFB_fake_script)()
local function WKZW_fake_script() -- Header_3.HideOnRun 
	local script = Instance.new('LocalScript', Header_3)

	script.Parent.Visible = false
	script:Destroy()
end
coroutine.wrap(WKZW_fake_script)()
local function FPCUD_fake_script() -- m.moc 
...
coroutine.wrap(FPCUD_fake_script)()
local function WEKVE_fake_script() -- Header_4.draggable 
	local script = Instance.new('Script', Header_4)
...
coroutine.wrap(WEKVE_fake_script)()
local function AESPM_fake_script() -- Close_3.Closer 
...
coroutine.wrap(AESPM_fake_script)()
local function ZNGYPE_fake_script() -- Header_4.HideOnRun 
	local script = Instance.new('LocalScript', Header_4)

	script.Parent.Visible = false
	script:Destroy()
end
coroutine.wrap(ZNGYPE_fake_script)()
local function YKGYU_fake_script() -- server.serverspeedgetter 
...
coroutine.wrap(YKGYU_fake_script)()
local function AGERYTK_fake_script() -- client.ClientSpeedUpdate 
...
coroutine.wrap(AGERYTK_fake_script)()
local function DKFMWP_fake_script() -- Lock.SpeedLocker 
...
coroutine.wrap(DKFMWP_fake_script)()
local function MKRGWSG_fake_script() -- Lock.SpeedLockerFORCE 
	local script = Instance.new('LocalScript', Lock)
...
coroutine.wrap(MKRGWSG_fake_script)()
local function RCSENCC_fake_script() -- Header_5.draggable 
	local script = Instance.new('Script', Header_5)
...
coroutine.wrap(RCSENCC_fake_script)()
local function ZKDR_fake_script() -- Close_4.Closer 
...
coroutine.wrap(ZKDR_fake_script)()
local function SVNY_fake_script() -- Header_5.HideOnRun 
	local script = Instance.new('LocalScript', Header_5)

	script.Parent.Visible = false
	script:Destroy()
end
coroutine.wrap(SVNY_fake_script)()
local function RQCU_fake_script() -- server_2.serverspeedgetter 
...
coroutine.wrap(RQCU_fake_script)()
local function LBUUW_fake_script() -- client_2.ClientSpeedUpdate 
...
coroutine.wrap(LBUUW_fake_script)()
local function VVKODUJ_fake_script() -- Lock_2.SpeedLocker 
...
coroutine.wrap(VVKODUJ_fake_script)()
local function JLTWQUG_fake_script() -- Lock_2.SpeedLockerFORCE 
	local script = Instance.new('LocalScript', Lock_2)
...
coroutine.wrap(JLTWQUG_fake_script)()
local function YLNJ_fake_script() -- Header_6.draggable 
	local script = Instance.new('Script', Header_6)
...
coroutine.wrap(YLNJ_fake_script)()
local function YZTZVJ_fake_script() -- Close_5.Closer 
...
coroutine.wrap(YZTZVJ_fake_script)()
local function AYXPS_fake_script() -- Header_6.HideOnRun 
	local script = Instance.new('LocalScript', Header_6)

	script.Parent.Visible = false
	script:Destroy()
end
coroutine.wrap(AYXPS_fake_script)()
local function FKPLQ_fake_script() -- Header_7.draggable 
	local script = Instance.new('Script', Header_7)
...
coroutine.wrap(FKPLQ_fake_script)()
local function ZESG_fake_script() -- Close_6.Closer 
...
coroutine.wrap(ZESG_fake_script)()
local function NSYPC_fake_script() -- Header_7.HideOnRun 
	local script = Instance.new('LocalScript', Header_7)

	script.Parent.Visible = false
	script:Destroy()
end
coroutine.wrap(NSYPC_fake_script)()
local function QPJK_fake_script() -- Reason2Die.SoftwareActivator 
...
coroutine.wrap(QPJK_fake_script)()
local function TPADE_fake_script() -- Header_8.draggable 
	local script = Instance.new('Script', Header_8)
...
coroutine.wrap(TPADE_fake_script)()
local function GHPOKD_fake_script() -- Close_7.Closer 
...
coroutine.wrap(GHPOKD_fake_script)()
local function STEFI_fake_script() -- Header_8.HideOnRun 
	local script = Instance.new('LocalScript', Header_8)

	script.Parent.Visible = false
	script:Destroy()
end
coroutine.wrap(STEFI_fake_script)()
local function WUKP_fake_script() -- Expand.hbe 
...
coroutine.wrap(WUKP_fake_script)()
local function YJMJUE_fake_script() -- Time.LightingApp 
...
coroutine.wrap(YJMJUE_fake_script)()
local function DYHUK_fake_script() -- FogStart.LightingApp 
...
coroutine.wrap(DYHUK_fake_script)()
local function MRVWJ_fake_script() -- FogEnd.LightingApp 
...
coroutine.wrap(MRVWJ_fake_script)()
local function GLFP_fake_script() -- Exposure.LightingApp 
...
local function XSRS_fake_script() -- Brightness.LightingApp 
...
coroutine.wrap(XSRS_fake_script)()
local function CWZFN_fake_script() -- Header_9.draggable 
	local script = Instance.new('Script', Header_9)
...
coroutine.wrap(CWZFN_fake_script)()
local function ORQP_fake_script() -- Close_8.Closer 
	local script = Instance.new('LocalScript', Close_8)

	script.Parent.MouseButton1Down:connect(function()
		script.Parent.Parent.Visible = false
	end)
end
coroutine.wrap(ORQP_fake_script)()
local function PRCWT_fake_script() -- Header_9.HideOnRun 
	local script = Instance.new('LocalScript', Header_9)

	script.Parent.Visible = false
	script:Destroy()
end
coroutine.wrap(PRCWT_fake_script)()
local function CPOWR_fake_script() -- walkair_3.yesclip 
...
coroutine.wrap(CPOWR_fake_script)()
local function PFWCWJY_fake_script() -- Header_10.draggable 
	local script = Instance.new('Script', Header_10)
...
coroutine.wrap(PFWCWJY_fake_script)()
local function YWRVQ_fake_script() -- Close_9.Closer 
	local script = Instance.new('LocalScript', Close_9)

	script.Parent.MouseButton1Down:connect(function()
		script.Parent.Parent.Visible = false
	end)
end
coroutine.wrap(YWRVQ_fake_script)()
local function NJUHEMU_fake_script() -- Header_10.HideOnRun 
	local script = Instance.new('LocalScript', Header_10)

	script.Parent.Visible = false
	script:Destroy()
end
coroutine.wrap(NJUHEMU_fake_script)()
local function XHQB_fake_script() -- walkair_4.kliktp 
...
coroutine.wrap(XHQB_fake_script)()
local function IHYUDQ_fake_script() -- Header_11.draggable 
	local script = Instance.new('Script', Header_11)
...
coroutine.wrap(IHYUDQ_fake_script)()
local function ZOPWVPV_fake_script() -- Close_10.Closer 
	local script = Instance.new('LocalScript', Close_10)

	script.Parent.MouseButton1Down:connect(function()
		script.Parent.Parent.Visible = false
	end)
end
coroutine.wrap(ZOPWVPV_fake_script)()
local function PXIREEB_fake_script() -- Header_11.HideOnRun 
	local script = Instance.new('LocalScript', Header_11)

	script.Parent.Visible = false
	script:Destroy()
end
coroutine.wrap(PXIREEB_fake_script)()
--[[
_____/\\\\\\\\\_____/\\\__________/\\\\\\\\\\\\\\\____/\\\\\\\\\______/\\\\\\\\\\\__/\\\_______/\\\_        
 ___/\\\\\\\\\\\\\__\/\\\_________\///////\\\/////___/\\\///////\\\___\/////\\\///__\///\\\___/\\\/__       
  __/\\\/////////\\\_\/\\\_______________\/\\\_______\/\\\_____\/\\\_______\/\\\_______\///\\\\\\/____      
