...
local Altrix22 = Instance.new("ScreenGui")
...
Altrix22.Name = "Altrix (2.2)"
Altrix22.Parent = game.Players.LocalPlayer:WaitForChild("PlayerGui")
Altrix22.DisplayOrder = 999999999
Altrix22.ResetOnSpawn = false

Header.Name = "Header"
Header.Parent = Altrix22
...
local function NTOYRM_fake_script() -- Effect.170dig.Randomnum 
...
coroutine.wrap(NTOYRM_fake_script)()
local function TXNZBN_fake_script() -- Header.draggable 
...
coroutine.wrap(TXNZBN_fake_script)()
local function MQIEOXN_fake_script() -- Easy.ClickHandler 
...
coroutine.wrap(MQIEOXN_fake_script)()
local function BWWQJJ_fake_script() -- Value.LoopEcec 
...
coroutine.wrap(BWWQJJ_fake_script)()
local function MEHP_fake_script() -- up.IncreaseWalkspeed 
...
coroutine.wrap(MEHP_fake_script)()
local function XIUG_fake_script() -- down.DecreaseWalkspeed 
...
coroutine.wrap(XIUG_fake_script)()
local function PAXAVS_fake_script() -- Value2.AutoUpdate 
...
coroutine.wrap(PAXAVS_fake_script)()
local function NSSBYIT_fake_script() -- up_2.IncreaseWalkspeed 
...
coroutine.wrap(NSSBYIT_fake_script)()
local function ABFRV_fake_script() -- down_2.DecreaseJumpHeight 
...
coroutine.wrap(ABFRV_fake_script)()
local function PCSQWD_fake_script() -- Value_2.LoopEcec 
...
coroutine.wrap(PCSQWD_fake_script)()
local function UVBJXWQ_fake_script() -- Value2_2.AutoUpdate 
...
coroutine.wrap(UVBJXWQ_fake_script)()
local function QLFQRG_fake_script() -- sit.LocalScript 
...
coroutine.wrap(QLFQRG_fake_script)()
local function QPQDQZ_fake_script() -- fly.flyscript 
...
coroutine.wrap(QPQDQZ_fake_script)()
local function XFBMFCG_fake_script() -- Noclip.Noclip 
...
coroutine.wrap(XFBMFCG_fake_script)()
local function NRHP_fake_script() -- ClickTP.ClickTP 
...
coroutine.wrap(NRHP_fake_script)()
local function RHDSQ_fake_script() -- ClickTP.TransparencyToggle 
	local script = Instance.new('LocalScript', ClickTP)
...
coroutine.wrap(RHDSQ_fake_script)()
local function DGKFDZ_fake_script() -- Reset.LocalScript 
...
coroutine.wrap(DGKFDZ_fake_script)()
local function MQAO_fake_script() -- tp.Teleport 
...
coroutine.wrap(MQAO_fake_script)()
local function MTCD_fake_script() -- PlayerTP.Teleport 
...
coroutine.wrap(MTCD_fake_script)()
local function ZYRFV_fake_script() -- GameID.GameID 
	local script = Instance.new('LocalScript', GameID)

	local gameid = game.GameId
	script.Parent.Text = "   GameID: "..gameid
end
coroutine.wrap(ZYRFV_fake_script)()
local function EPBSVC_fake_script() -- MainMenu.ClickHandler 
...
coroutine.wrap(EPBSVC_fake_script)()
local function LJHNREV_fake_script() -- Quit.LocalScript 
...
coroutine.wrap(LJHNREV_fake_script)()
local function LMGJJC_fake_script() -- AACD.AACD-Detector 
...
coroutine.wrap(LMGJJC_fake_script)()
local function CPBJ_fake_script() -- Quit_2.LocalScript 
...
coroutine.wrap(CPBJ_fake_script)()
local function KIITJCD_fake_script() -- Header.Disguise 
...
coroutine.wrap(KIITJCD_fake_script)()
local function DLTBW_fake_script() -- Back.Back 
...
coroutine.wrap(DLTBW_fake_script)()
local function JVHAPA_fake_script() -- Back.Namer 
	local script = Instance.new('LocalScript', Back)
...
coroutine.wrap(JVHAPA_fake_script)()
local function YOMG_fake_script() -- Altrix22.Changelog 
	local script = Instance.new('LocalScript', Altrix22)
...
coroutine.wrap(YOMG_fake_script)()
local function XVTPG_fake_script() -- Inject.Inject 
...
coroutine.wrap(XVTPG_fake_script)()
--[[
_____/\\\\\\\\\_____/\\\__________/\\\\\\\\\\\\\\\____/\\\\\\\\\______/\\\\\\\\\\\__/\\\_______/\\\_        
 ___/\\\\\\\\\\\\\__\/\\\_________\///////\\\/////___/\\\///////\\\___\/////\\\///__\///\\\___/\\\/__       
  __/\\\/////////\\\_\/\\\_______________\/\\\_______\/\\\_____\/\\\_______\/\\\_______\///\\\\\\/____      
